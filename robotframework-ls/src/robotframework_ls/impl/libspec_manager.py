    ...
    def __init__(
        ...
        *,
        ...
        if pre_generate_libspecs:
            ...
            self.libspec_markdown_conversion: Optional[LibspecMarkdownConversion] = (
        ...
        self._pythonpath_folder_to_folder_info: Dict[str, _FolderInfo] = (
    ...
    def _iter_lib_info(self, builtin=False):
        ...
        for canonical_filename_to_info, can_regenerate in iter_in:
            for canonical_spec_filename, info in list(
                ...
                if info is None:
                    info = canonical_filename_to_info[canonical_spec_filename] = (
